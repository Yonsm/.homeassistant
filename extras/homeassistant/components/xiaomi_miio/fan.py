...
PRESET_MODES_AIRFRESH = OPERATION_MODES_AIRFRESH #["Auto", "Interval"]
...
class XiaomiAirFresh(XiaomiGenericDevice):
    ...
    PRESET_MODE_MAPPING = {
        ...
        "Silent": AirfreshOperationMode.Silent,
        "Interval": AirfreshOperationMode.Interval,
        "Low": AirfreshOperationMode.Low,
        "Middle": AirfreshOperationMode.Middle,
        "Strong": AirfreshOperationMode.Strong,
    }
